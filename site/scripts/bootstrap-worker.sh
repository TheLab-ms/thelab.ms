#!/usr/bin/env bash
# Bootstrap the default Worker in wrangler.jsonc. See ../../README.md.
set -euo pipefail
umask 077
...
usage() {
  printf '%s\n' \
    ...
    'selected via CLOUDFLARE_ACCOUNT_ID or wrangler.jsonc. See the repository README.'
}
...
printf '%s\n' 'Remote bootstrap complete. See the repository README for provider and domain setup.'
