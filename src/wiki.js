...
export async function wikiRequest(request, env) {
	...
	try {
		...
		if (reading && !newPage && action !== 'edit') {
			...
			if (!page) return wikiPage('Page not found', `<h1>Page not found</h1><p>This page has not been created, or has been deleted.</p><p><a href="/wiki/${e(slug)}/edit">Create this page</a> · <a href="/wiki">Index</a></p>`, { status: 404 });
